...
@ComponentScan(basePackages = {"com.testing.two.application.repositories.generichibernate","com.testing.two.application.service.dao.generichibernate"})
public class GenericHibernateConfig {
